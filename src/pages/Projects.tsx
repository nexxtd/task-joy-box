              ...
              >
                {(provided) => (
                  <div ref={provided.innerRef} {...provided.droppableProps} className="flex gap-6 items-start select-none">
                    ...
                    {addingColumn ? (
                      <div className="flex-shrink-0 w-[640px] max-w-[90vw] animate-fade-in bg-card border border-border rounded-2xl p-4" data-no-pan="true">
                        <input
                          autoFocus
                          value={newColTitle}
                      ...
                      <button
                        ...
                        data-no-pan="true"
                        className="flex-shrink-0 w-[640px] max-w-[90vw] flex items-center justify-center gap-2 px-4 py-4 text-sm font-semibold text-muted-foreground hover:text-foreground border border-dashed border-border hover:border-foreground/30 rounded-2xl transition-colors bg-card/40"
                      >
