...
const WhatsNew: React.FC = () => {
  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto bg-background flex p-4">
      <div className="m-auto w-full max-w-lg bg-card border border-border rounded-2xl shadow-lg overflow-hidden animate-fade-in">
