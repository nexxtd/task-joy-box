...
import goalTemplatesRoutes from './routes/goalTemplates.js';
import habitTemplatesRoutes from './routes/habitTemplates.js';
...
app.use('/api/goal-templates', goalTemplatesRoutes);
app.use('/api/habit-templates', habitTemplatesRoutes);
